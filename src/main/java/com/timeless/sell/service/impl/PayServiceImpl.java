...
import com.timeless.sell.vo.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO) {
        ...
        log.info("【微信支付】发起支付，request={}", JSONObject.toJSONString(payRequest, true));
        
        PayResponse payResponse = bestPayService.pay(payRequest);
        log.info("【微信支付】发起支付，response={}", JSONObject.toJSONString(payResponse, true));
        return payResponse;
    }
    ...
    public PayResponse notify(String notifyData) {
        ...
        //判断金额是否一致
        if(!MathUtil.euqals(payResponse.getOrderAmount(), orderDTO.getOrderAmount().doubleValue())){
